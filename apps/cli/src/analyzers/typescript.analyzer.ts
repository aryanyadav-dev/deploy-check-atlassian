/**
 * Enhanced TypeScript Analyzer for CLI
 * Detects breaking API changes in TypeScript/JavaScript files using comprehensive AST analysis.
 * 
 * Supports detection of breaking changes in:
 * - Functions (parameters, return types, async modifiers, type parameters)
 * - Classes (methods, properties, constructors, inheritance, visibility)
 * - Interfaces (properties, methods, extends)
 * - Type Aliases (definition changes, type parameters)
 * - Enums (members, values, const modifier)
